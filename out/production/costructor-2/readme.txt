...
takes a studentName parameter and assign it to the
object's instance variable name

-a method getStudentDetails() that prints
...
-a constructor method that simply inform the
user about the creation of a Teacher object

-a method assignGrade() that
takes 2 params:
-alum of type Student
-a int finalGrade
and assigns finalGrade to the Student's grade
